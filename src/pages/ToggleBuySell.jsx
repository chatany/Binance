    ...
    >
      ...
      {activeTab === "Market" && (
        ...
        >
          {activeItem === "Buy" ? (
            <div
              className={`w-full pb-10 mb-5  transition-all duration-500 delay-1000 ${
            ...
            <div
              className={`w-full  transition-all mb-5 duration-500 pb-10 delay-100 ${
                isOpen ? "space-y-3" : "space-y-0"
              } `}
            >
      ...
      {activeTab === "Stop Limit" && (
        ...
        >
          {activeItem === "Buy" ? (
            <div
              className={`w-full  transition-all duration-500 mb-5 pb-10 delay-1000 ${
                isOpen ? "space-y-1.5" : "space-y-0"
              }`}
            >
              <div className="p-[5px] flex flex-col gap-2">
            ...
            <div
              className={`w-full  transition-all pb-10 mb-5 duration-500 delay-100 ${
                isOpen ? "space-y-1.5" : "space-y-0"
              } `}
            >
              <div
